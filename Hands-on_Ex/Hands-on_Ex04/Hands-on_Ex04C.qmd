...
-   ggdist for visualising distribution and uncertainty.al colors or color palettes, manipulating these colors, and employing them in various kinds of visualisations.
...
### 7.3.1 Plotting standard error bars of estimates
...
exam %>% 
  ...
  labs(
    title    = "Visualising confidence intervals of mean math score",
    subtitle = "Mean point with 95 % and 99 % intervals"
  )
