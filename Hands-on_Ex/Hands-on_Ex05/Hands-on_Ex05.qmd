...
pacman::p_load(
  ...
  tidyverse, graphlayouts, concaveman,
  ggforce
)
```
...
Please be reminded that you must to install and include [**ggforce**](https://ggforce.data-imaginist.com/) and [**concaveman**](https://www.rdocumentation.org/packages/concaveman/versions/1.1.0/topics/concaveman) packages before running the code chunk below.**9.8 Building Interactive Network Graph with visNetwork**
:::
